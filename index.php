        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                echo "<tr>
                        ...
                        <td>{$row['nama_mhs']}</td>
                        <td>{$row['nama_mk']}</td>
                        <td><span style='color:hotpink; font-weight:bold;'>{$row['nama_mhs']}</span> Mengambil Mata Kuliah <span style='color:hotpink; font-weight:bold;'>{$row['nama_mk']}</span> ({$row['jumlah_sks']} SKS)</td>
                        <td>
